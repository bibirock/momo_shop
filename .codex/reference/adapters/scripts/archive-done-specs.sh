...
#
# 見 .codex/reference/adapters/local-file.md「擴充操作 › LOCALFILE.archiveDoneSpecs()」。
#
...
#   bash .codex/reference/adapters/scripts/archive-done-specs.sh --dry-run
#   bash .codex/reference/adapters/scripts/archive-done-specs.sh
